  ...
  const [currentTheme, setCurrentTheme] = useState<VenueTheme>(() => {
    if (initialVenue) {
      return {
        ...
        logoUrl: initialVenue.logoUrl || initialVenue.photoUrl || '',
        photoUrl: initialVenue.ballroomImageUrl || initialVenue.photoUrl || '',
        venueBallroomUrl: initialVenue.ballroomImageUrl || initialVenue.photoUrl || '',
      ...
      try {
        ...
        if (venue) {
          return {
            ...
            logoUrl: venue.logoUrl || venue.photoUrl || '',
            photoUrl: venue.ballroomImageUrl || venue.photoUrl || '',
            venueBallroomUrl: venue.ballroomImageUrl || venue.photoUrl || '',
